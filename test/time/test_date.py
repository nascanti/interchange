...
from interchange.time import Duration, Date, UnixEpoch, ZeroDate
...
class DateTestCase(TestCase):
    ...
    def test_repr(self):
        self.assertEqual(repr(Date(2018, 4, 30)), "Date(2018, 4, 30)")
        self.assertEqual(repr(Date(0, 0, 0)), "ZeroDate")
